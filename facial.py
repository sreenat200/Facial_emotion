...
try:
    ...
    st.error("Hugging Face Hub is not installed. Please install it using: pip install huggingface_hub")

# Only proceed if all required packages are available
if cv2_available and torch_available and hf_hub_available:
    ...
    st.error("Required packages are missing. Please install all dependencies.")
    st.code("pip install opencv-python-headless torch torchvision huggingface_hub")
